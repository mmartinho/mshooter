 ...
 * Data: Ago/2022
 * Arquivo: Classe controladora "Reutilizacao" de Insumo
 ************************************************************************************/
...
class ReutilizacaoController extends CRUDController {
    ...
    static async cria(req, res) {
        try {
            ...
            if(movimentacaoCriada) {
                ...
                return res.status(400).json({message: `Não foi possível criar Movimentação`});
            }           
        } catch (error) {
...
module.exports = ReutilizacaoController;